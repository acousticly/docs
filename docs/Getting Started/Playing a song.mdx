...
After [inviting Acoustic into your server](/adding-acoustic), you can get the party started! To begin playing songs through Acoustic, follow this guide:
...
- Use the command `~play` to start your music.
  ...
  >
    <TabItem value="ps">
      {' '}
      To play a song, type <code>~play &lt;Song Name/Song URL&gt;</code>
      <br />
      <br />
      <Image
    ...
    <TabItem value="pp">
      {' '}
      To play a playlist, type <code>~play &lt;PlaylistURL&gt;</code>
      <br />
      <br />
      <Image
