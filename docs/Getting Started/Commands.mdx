...
| Coinflip    | Choose heads or tails with a bet.                                                                | `coinflip \<heads/tails> \<bet>`    |
...
| Postmeme    | Posts a random meme and gives you money based on its popularity.                                 | `pm`                                |
| Search      | Searches under an item of your choice and gives you a random amount of money.                    | `search`                            |
| Upgrade    | Buy/view upgrades you can do on your base                                                         | `upgrade \<buy/view> \<upgrade id>` |
