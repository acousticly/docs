...
custom_edit_url: https://github.com/acousticly/docs/edit/master/docs/Adding%20Acoustic.mdx
author: Joel Marcey
---
...
<table>
  <tr>
    <th>
      <Button
        onClick={() => window.open('https://acoustic.to/invite', '_blank')}
    ...
    <td>
      <ul>
        <h2>
          <Highlight color="#5865F2">👋 Acoustic</Highlight> (
          <code>Acoustic#8707</code>)
        </h2>
        <li>
          Prefix: <code>~</code>
        </li>
...
<Image img={require('../static/img/docs/adding/oauth.png')} />
...
<Image img={require('../static/img/docs/adding/oauth-deux.png')} />
