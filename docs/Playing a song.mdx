...
## 1. Join a Voice Channel.
  ...
  <Image img={require('../static/img/docs/playing-a-song/joinVC.png')} />
...
## 3. Start your music.
  ...
  <Tabs
    ...
    <TabItem value="ps"> To play a song, type <code>~play &lt;Song Name/Song URL&gt;</code><br/><br/>
      <img src="/img/docs/playing-a-song/play_song_string.png" alt="playing a song using slash commands"/>
    </TabItem>
    <TabItem value="pp"> To play a playlist, type <code>~play &lt;PlaylistURL&gt;</code><br/><br/>
      <img src="/img/docs/playing-a-song/playlist.png" alt="playing a playlist using slash commands"/>
    </TabItem>
  </Tabs>
